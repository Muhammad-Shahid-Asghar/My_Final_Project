# ============================================================
# SkinCare AI — EfficientNet-B0 Training
...
PLOT_DIR    = os.path.join(DERMAI_DIR, "plots", "efficientnet_b0")

MODEL_NAME  = 'efficientnet_b0'
SAVE_NAME   = 'best_efficientnet_b0.pth'
NUM_CLASSES = 11
IMG_SIZE    = 224
BATCH_SIZE  = 8
GRAD_ACCUM  = 2
...
CLASS_NAMES = [
    ...
    "Normal Skin",   # ← yeh add karo
]
CLASS_SHORT = [
    "Eczema", "Warts", "Melanoma", "Atopic D.",
    "BCC", "Nevi", "Ben.Ker", "Psoriasis", "Seb.Ker", "Tinea", "Normal"  # ← Normal add
]
...
print(f"\n{'='*60}")
print(f"  SkinCare AI — EfficientNet-B0 Training")
print(f"{'='*60}")
...
def main():
    ...
    print(f"\n{'='*60}")
    print(f"  EfficientNet-B0 Training Complete!")
