# ============================================================
# SkinCare AI — MobileNetV3 Training
# Run: python train_mobilenetv3.py
# ✅ FIXED: classifier feature dimension auto-detection
# ============================================================
...
PLOT_DIR    = os.path.join(DERMAI_DIR, "plots", "mobilenetv3")

MODEL_NAME  = 'mobilenetv3_large_100'
SAVE_NAME   = 'best_mobilenetv3.pth'
...
print(f"\n{'='*60}")
print(f"  SkinCare AI — MobileNetV3 Training")
print(f"{'='*60}")
...
# ============================================================
# ✅ MODEL — FIXED: Auto-detect actual output features
# ============================================================
class SkinModel(nn.Module):
    def __init__(self):
        ...
        # ✅ FIX: Get ACTUAL output features via dummy forward pass
        # backbone.num_features returns internal features (960),
        # but actual output after global pooling is 1280 for mobilenetv3_large_100
        self.backbone.eval()
        with torch.no_grad():
        ...
        print(f"  backbone.num_features (internal) : {self.backbone.num_features}")
        print(f"  Actual output features (fixed)   : {actual_features}  ✅")
        print(f"  Classifier       : Linear({actual_features} → {NUM_CLASSES})")
...
def main():
    ...
    print(f"\n  Phase 1: Epochs 1-5   (classifier head only)")
    ...
    print(f"\n{'='*60}")
    print(f"  MobileNetV3 Training Complete!")
